...
dimention of the data. Default value is 2 (point)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}3}]:} \PY{k}{class} \PY{n+nc}{KMeans}\PY{p}{:}
...
\end{quote}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}4}]:}     \PY{k}{def} \PY{n+nf}{getNumOfClusters}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{)}\PY{p}{:}
...
the future modification easier.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}26}]:}     \PY{k}{def} \PY{n+nf}{run}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{)}\PY{p}{:}
         ...
         \PY{l+s+sd}{        \PYZdq{}\PYZdq{}\PYZdq{}}
                 ...
                 \PY{k}{while}\PY{p}{(}\PY{n}{energy\PYZus{}thisTurn} \PY{o}{!=} \PY{n}{energy\PYZus{}prev}\PY{p}{)}\PY{p}{:}
                     ...
                     \PY{n}{ite} \PY{o}{+}\PY{o}{=} \PY{l+m+mi}{1}
                     \PY{k}{if} \PY{n}{ite} \PY{o}{==} \PY{l+m+mi}{2}\PY{p}{:}  \PY{c+c1}{\PYZsh{} plot the result of first iteration}
                         \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{plotGraph}\PY{p}{(}\PY{p}{)} 
...
\]
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:}     \PY{k}{def} \PY{n+nf}{\PYZus{}computeEnergy}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{)}\PY{p}{:}
...
We seperate each step to different function.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:}     \PY{k}{def} \PY{n+nf}{generatePointCluster}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{)}\PY{p}{:}
...
set, then put them into a \texttt{points} list.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}8}]:}     \PY{k}{def} \PY{n+nf}{\PYZus{}generatePoints}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{)}\PY{p}{:}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}9}]:}     \PY{k}{def} \PY{n+nf}{\PYZus{}initialLabel}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{)}\PY{p}{:}
...
offset.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}10}]:}     \PY{k}{def} \PY{n+nf}{\PYZus{}dispersePoints}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{)}\PY{p}{:}
...
value as the centroid.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:}     \PY{k}{def} \PY{n+nf}{\PYZus{}computeCentroid}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{)}\PY{p}{:}
...
different functions.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:}     \PY{k}{def} \PY{n+nf}{\PYZus{}clustering}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{)}\PY{p}{:}
...
After all computation, update the \texttt{clusters} list.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}13}]:}     \PY{k}{def} \PY{n+nf}{\PYZus{}assignLabel}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{)}\PY{p}{:}
...
directly, it gives us the \emph{Euclidean distance} between two vectors.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}14}]:}     \PY{k}{def} \PY{n+nf}{\PYZus{}computeDistance}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{,} \PY{n}{x}\PY{p}{,} \PY{n}{y}\PY{p}{)}\PY{p}{:}
...
Next, we define some functions to visualise the result.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}24}]:} \PY{c+c1}{\PYZsh{} Function to plot the result of the result, both clusters and centroids}
         \PY{k}{def} \PY{n+nf}{plotGraph}\PY{p}{(}\PY{n+nb+bp}{self}\PY{p}{)}\PY{p}{:}
             ...
             \PY{k}{for} \PY{n}{i} \PY{o+ow}{in} \PY{n+nb}{range}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{clusters}\PY{p}{)}\PY{p}{)}\PY{p}{:}
                 \PY{k}{for} \PY{n}{x}\PY{p}{,} \PY{n}{y} \PY{o+ow}{in} \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{clusters}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{:}
                     \PY{n}{plt}\PY{o}{.}\PY{n}{scatter}\PY{p}{(}\PY{n}{x}\PY{p}{,} \PY{n}{y}\PY{p}{,} \PY{n}{marker}\PY{o}{=}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{.}\PY{l+s+s1}{\PYZsq{}}\PY{p}{,} \PY{n}{color}\PY{o}{=}\PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{colors}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{)}
                 \PY{n}{x\PYZus{}centroid} \PY{o}{=} \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{centroids}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{0}\PY{p}{]}
                 \PY{n}{y\PYZus{}centroid} \PY{o}{=} \PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{centroids}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
                 \PY{n}{plt}\PY{o}{.}\PY{n}{scatter}\PY{p}{(}
                     ...
                     \PY{n}{color}\PY{o}{=}\PY{n+nb+bp}{self}\PY{o}{.}\PY{n}{colors}\PY{p}{[}\PY{n}{i}\PY{p}{]}\PY{p}{)}
             \PY{n}{plt}\PY{o}{.}\PY{n}{show}\PY{p}{(}\PY{p}{)}
         \PY{c+c1}{\PYZsh{} for jupyter notebook}
         \PY{n}{KMeans}\PY{o}{.}\PY{n}{plotGraph} \PY{o}{=} \PY{n}{plotGraph}
...
First try \texttt{k=3,\ num\_points=100}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}16}]:} \PY{k}{if} \PY{n+nv+vm}{\PYZus{}\PYZus{}name\PYZus{}\PYZus{}} \PY{o}{==} \PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{\PYZus{}\PYZus{}main\PYZus{}\PYZus{}}\PY{l+s+s1}{\PYZsq{}}\PY{p}{:}
...
\begin{center}\rule{0.5\linewidth}{\linethickness}\end{center}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}22}]:}     \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s1}{Initial Label:}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
We can see from the picture, different color points are mixed together.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}25}]:}     \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s1}{Initial Centroids:}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
             \PY{n}{kmeans\PYZus{}1}\PY{o}{.}\PY{n}{plotGraph}\PY{p}{(}\PY{p}{)}  \PY{c+c1}{\PYZsh{} initial centroids}
\end{Verbatim}
...
Because the labelling is done randomly, the centroids have no spectial
meaning.\\
In this picture, we see two centroids even overlapped.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}28}]:}     \PY{n}{kmeans\PYZus{}1}\PY{o}{.}\PY{n}{run}\PY{p}{(}\PY{p}{)}
\end{Verbatim}
    ...
    After first iteration, we can see from the graph that the clustering
result is improved a lot. The three clusters were basically seperated.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}29}]:}     \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s1}{Final Label:}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
Final Centroids:
    ...
    Now we get the final result, basically all points find the centroid that
closest with them.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}30}]:}     \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+se}{\PYZbs{}n}\PY{l+s+s1}{Energy change:}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
...
Let's try some other inputs: \texttt{k} = 5, \texttt{num\_points} = 300
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}33}]:} \PY{n}{kmeans\PYZus{}2} \PY{o}{=} \PY{n}{KMeans}\PY{p}{(}\PY{l+m+mi}{5}\PY{p}{,} \PY{l+m+mi}{300}\PY{p}{)}
         ...
         \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{First iteration:}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}
